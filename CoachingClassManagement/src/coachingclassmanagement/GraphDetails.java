 ...
 * @author yogesh
 */
public class GraphDetails extends javax.swing.JFrame {

    /**
     * Creates new form GraphDetails
     */
    public GraphDetails() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GraphDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GraphDetails().setVisible(true);
            }
        });
    }
